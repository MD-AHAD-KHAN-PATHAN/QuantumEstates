            ...
            <div className="bg-base-100 drop-shadow-xl relative">
                ...
                <div className="p-5">
                    ...
                    <div className="flex justify-between mt-8 font-bold">
                        ...
                        <button className="text-white rounded-full p-2 bg-red-500">Delete</button>
                        <button className="text-white rounded-full p-2 bg-teal-500">Update</button>

                    </div>

                    <div className="divider"></div>
                    <div>
                        <div className="avatar gap-3 font-bold">
                            <div className="rounded-full w-12 h-12">
                                <img className="" src={user?.photoURL} alt="photo" />
                            </div>
                            <div>
                                <h1>{name}</h1>
                            </div>
